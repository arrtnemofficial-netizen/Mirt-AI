...
# Intent to suggested state mapping
INTENT_STATE_HINTS: dict[str, str] = {
    ...
    "SIZE_QUESTION": "STATE_2_REFINEMENT",
    "PRICE_QUESTION": "STATE_2_REFINEMENT",
    "AVAILABILITY_QUESTION": "STATE_2_REFINEMENT",
    "COMPARISON_REQUEST": "STATE_2_REFINEMENT",
    "POSITIVE_FEEDBACK": "STATE_3_OFFER",
    "READY_TO_BUY": "STATE_5_CLOSE",
    "OBJECTION_PRICE": "STATE_4_OBJECTION",
    "OBJECTION_QUALITY": "STATE_4_OBJECTION",
    "OBJECTION_DELIVERY": "STATE_4_OBJECTION",
    "REQUEST_DISCOUNT": "STATE_4_OBJECTION",
    "ORDER_INTENT": "STATE_5_CLOSE",
    "FAREWELL": "STATE_5_CLOSE",
    "OFF_TOPIC": "STATE_0_INIT",
...
class StateValidator:
    ...
    def _get_next_progression(self, current: str) -> str:
        ...
        progression = {
            ...
            "STATE_1_DISCOVERY": "STATE_2_REFINEMENT",
            "STATE_2_REFINEMENT": "STATE_3_OFFER",
            "STATE_3_OFFER": "STATE_5_CLOSE",
            "STATE_4_OBJECTION": "STATE_3_OFFER",
            "STATE_5_CLOSE": "STATE_0_INIT",
        }
