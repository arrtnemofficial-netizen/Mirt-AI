...
class TestAgentNodeV2:
    ...
    @pytest.mark.asyncio
    async def test_agent_handles_moderation_escalation(self, state_with_user_message, mock_agent_response):
...
class TestValidationNode:
    ...
    async def test_validation_detects_price_error(self, state_with_user_message):
        ...
        invalid_response = {
            "event": "offer",
            "products": [{"id": 1, "name": "Test", "price": 0, "photo_url": "https://example.com/1.jpg"}],
            "metadata": {"session_id": "test-session-123"},
        }
