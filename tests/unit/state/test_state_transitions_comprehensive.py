...
class TestMasterRouterTransitions:
    ...
    def test_waiting_for_size_with_beru_routes_to_payment(self):
        ...
        assert result == "payment", (
            f"WAITING_FOR_SIZE with 'беру' should route to payment, got {result}"
        )
    ...
    def test_waiting_for_color_with_beru_routes_to_payment(self):
        ...
        result = master_router(state)
        assert result == "payment", (
            f"WAITING_FOR_COLOR with 'беру' should route to payment, got {result}"
        )
    ...
    def test_waiting_for_payment_method_routes_to_payment(self):
        ...
        result = master_router(state)
        assert result == "payment", (
            f"WAITING_FOR_PAYMENT_METHOD should route to payment, got {result}"
        )
    ...
    def test_waiting_for_payment_proof_routes_to_payment(self):
        ...
        result = master_router(state)
        assert result == "payment", (
            f"WAITING_FOR_PAYMENT_PROOF should route to payment, got {result}"
        )
    ...
    def test_completed_with_new_query_routes_to_moderation(self):
        ...
        assert result == "moderation", (
            f"COMPLETED with new query should route to moderation, got {result}"
        )
...
class TestRouteAfterIntent:
    ...
    def test_payment_delivery_in_offer_state_routes_to_payment(self):
        ...
        result = route_after_intent(state)
        assert result == "payment", (
            f"PAYMENT_DELIVERY in OFFER should route to payment, got {result}"
        )
    ...
    def test_payment_delivery_in_payment_state_routes_to_payment(self):
        ...
        result = route_after_intent(state)
        assert result == "payment", (
            f"PAYMENT_DELIVERY in PAYMENT should route to payment, got {result}"
        )
    ...
    def test_payment_delivery_with_products_routes_to_offer(self):
        ...
        result = route_after_intent(state)
        assert result == "offer", (
            f"PAYMENT_DELIVERY with products should route to offer, got {result}"
        )
    ...
    def test_payment_delivery_without_products_routes_to_agent(self):
        ...
        result = route_after_intent(state)
        assert result == "agent", (
            f"PAYMENT_DELIVERY without products should route to agent, got {result}"
        )
...
class TestEdgeCases:
    ...
    def test_empty_messages(self):
        ...
        state = create_initial_state(
            session_id="empty_messages", messages=[], metadata={"channel": "instagram"}
        )
        state["dialog_phase"] = "INIT"
    ...
    def test_langchain_message_format(self):
        ...
        state = create_initial_state(
            session_id="langchain_format", messages=[], metadata={"channel": "instagram"}
        )
