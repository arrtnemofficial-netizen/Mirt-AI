...
class TestGatingLogic:
    ...
    @pytest.mark.asyncio
    async def test_75_gating_accepts_high_importance_high_surprise(
        self, memory_service, mock_supabase
    ):
    ...
    async def test_81_gating_bypass_flag(self, memory_service, mock_supabase):
        ...
        result = await memory_service.store_fact("user_123", fact, bypass_gating=True)
