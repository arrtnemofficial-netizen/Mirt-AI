...
CATALOG = {
    ...
    "3646358": {
        "name": "Сукня Анна (шоколад)",
        "price_uniform": True,
        "price": 1850,
        "colors": ["коричневий"],
    },
    "3663608": {
        "name": "Сукня Анна (лео рожева)",
        "price_uniform": True,
        "price": 1850,
        "colors": ["рожевий"],
    },
    "3646356": {
        "name": "Сукня Анна (сіра)",
        "price_uniform": True,
        "price": 1850,
        "colors": ["сірий"],
    },
    ...
    # Костюм Ритм
    "11089055": {
        "name": "Костюм Ритм (рожевий)",
        "price_uniform": True,
        "price": 1975,
        "colors": ["рожевий"],
    },
    "11089244": {
        "name": "Костюм Ритм (шоколад)",
        "price_uniform": True,
        "price": 1975,
        "colors": ["коричневий"],
    },
    "11089288": {
        "name": "Костюм Ритм (бордо)",
        "price_uniform": True,
        "price": 1975,
        "colors": ["бордовий"],
    },
    # Костюм Каприз
    "11100944": {
        "name": "Костюм Каприз (рожевий)",
        "price_uniform": True,
        "price": 1885,
        "colors": ["рожевий"],
    },
    "11101056": {
        "name": "Костюм Каприз (бордо)",
        "price_uniform": True,
        "price": 1885,
        "colors": ["бордовий"],
    },
    "11101074": {
        "name": "Костюм Каприз (шоколад)",
        "price_uniform": True,
        "price": 1885,
        "colors": ["коричневий"],
    },
    ...
    # Тренч екошкіра
    "3482676": {
        "name": "Тренч екошкіра (капучіно)",
        "price_uniform": True,
        "price": 2180,
        "colors": ["капучіно"],
    },
    "3482679": {
        "name": "Тренч екошкіра (молочний)",
        "price_uniform": True,
        "price": 2180,
        "colors": ["молочний"],
    },
    "3482682": {
        "name": "Тренч екошкіра (чорний)",
        "price_uniform": True,
        "price": 2180,
        "colors": ["чорний"],
    },
